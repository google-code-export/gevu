...
function getTypeLog(typeLog){
	//merci � http://www.jasondavies.com/coffee-wheel/	
	d3.json("http://www.gevu.org/public/stat/antenne?type=ArbreTypeLog&typeLog="+typeLog, function(json) {
		...
		path = vis.selectAll("path") //cr�er visualisation, ajoute des donnees, cr�er pr chaque �lement path(ligne)
		      .data(nodes) //ajoute nouvelle data (fonction qui permet de transformer les donnees en un mod�le de donnees partition qui n'est pas trier)
