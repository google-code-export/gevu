SELECT SUBSTRING(fdcRef.valeur,1,20),  
  COUNT(gc3.id_critere) moteur
          ...
          LEFT JOIN gevu.gevu_criteres gc1 ON gc1.ref = fdcRef.valeur AND gc1.handicateur_auditif > 0
          LEFT JOIN gevu.gevu_criteres gc2 ON gc2.ref = fdcRef.valeur AND gc2.handicateur_cognitif > 0
          LEFT JOIN gevu.gevu_criteres gc3 ON gc3.ref = fdcRef.valeur AND gc3.handicateur_moteur > 0
          LEFT JOIN gevu.gevu_criteres gc4 ON gc4.ref = fdcRef.valeur AND gc4.handicateur_visuel > 0
