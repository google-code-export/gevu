...
--
-- Serveur: localhost
-- Généré le : Dim 27 Novembre 2011 à 07:32
...
CREATE TABLE IF NOT EXISTS `gevu_espacesxinterieurs` (
  ...
  KEY `id_lieu` (`id_lieu`),
  KEY `id_instant` (`id_instant`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC AUTO_INCREMENT=14384 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC AUTO_INCREMENT=21980 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC AUTO_INCREMENT=6084 ;
