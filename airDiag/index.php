	...
	<vbox  flex="1" width="1280px" height="800px" style="overflow:auto">
		...
		<hbox>
			...
			<menubar id='choix_diagnostic'>
				...
				<menu label="Type de crit�re" class="menubar">
					<menupopup id="mnuTypeCrit" onpopupshowing="javascript:;">
						<menuitem id="type_controle1" type="checkbox" checked="<?php if($_SESSION['type_controle'][1]=="multiple_1_1") echo "true"; ?>" label="R�glementaire" value='multiple_1_1' oncommand="SetChoixDiagnostic();" />
				...
				<menu label="Contexte r�glementaire" onpopupshowing="javascript:;" class="menubar">
					<menupopup id="mnuContReg" >
						...
						<menuitem id="type_contexte6" type="checkbox" checked="<?php if($_SESSION['type_contexte'][5]=="multiple_2_6") echo "true"; ?>" label="Modalit� particuli�re" value='multiple_2_6' oncommand="SetChoixDiagnostic();"/>
					</menupopup>
				</menu>
				<menu label="Contexte �ditorial" onpopupshowing="javascript:;" class="menubar">
					<menupopup id="mnuContEdit" >
						...
						<menuitem id="ContEditPublie" type="radio" checked="<?php if($_SESSION['ContEditPublie']) echo "true"; ?>" label="Publi�" value='true' oncommand="SetChoixAffichage(this.id);"/>
					</menupopup>
				</menu>
				<menu label="Affichage" onpopupshowing="javascript:;" class="menubar">
					<menupopup id="mnuAffichage" >
						<menuitem id="ShowLegendeControle" value="true" type="checkbox" checked="<?php if($_SESSION['ShowLegendeControle']) echo "true"; else echo "false"; ?>"  label="Montrer la l�gende des contr�les" oncommand="SetChoixAffichage(this.id);"/>
		...
		<hbox class="global" id="global" flex="1">
			...
			<vbox class="BoiteV" flex="0" width="280px">
				<hbox id="RefId" >
					...
					<label value="S�lectionnez un �tablissement dans" id="TitreFormSaisi" hidden="true" />
				</hbox>
