...
class Model_DbTable_Gevu_typesxsolutions extends Zend_Db_Table_Abstract
{
    ...
    {        
        $this->update('gevu_typesxsolutions', $data, 'gevu_typesxsolutions.id_type_solution = ' . $id);
    }
    ...
    {
        $this->delete('gevu_typesxsolutions', 'gevu_typesxsolutions.id_type_solution = ' . $id);
    }
    ...
    {
        $query = $this->select()
                    ->from( array("%ftable%" => "gevu_typesxsolutions") );
